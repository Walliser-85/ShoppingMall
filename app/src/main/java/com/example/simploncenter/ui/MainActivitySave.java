...
public class MainActivitySave extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent h=new Intent (MainActivitySave.this, MainActivitySave.class);
            startActivity(h);
        } else if (id == R.id.nav_shops) {
            Intent h=new Intent (MainActivitySave.this, Shops.class);
            startActivity(h);
        } else if (id == R.id.nav_articles) {
            Intent h=new Intent (MainActivitySave.this, Articles.class);
            startActivity(h);
        } else if (id == R.id.nav_about) {
            Intent h=new Intent (MainActivitySave.this, About.class);
            startActivity(h);
        }
